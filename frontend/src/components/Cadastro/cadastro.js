        ...
        return (
            <>
                ...
                <section id="cadastrar">
                    <h4 id="titleCad">Cadastre sua hospedagem</h4>
                        ...
                        <div className="row">
                            ...
                            <div className="col-sm-9 col-md-7 col-lg-5 mx-auto column fundo">
                                ...
                                <div className="form-group input-group">
                                    <input name="" className="form-control" placeholder="Nome" type="text" />
                                </div>
                                <div className="form-group input-group">
                                    <input name="" className="form-control" placeholder="Descrição" type="text" />
                                </div>
                                <div className="form-group input-group">
                                    <input name="" className="form-control" placeholder="Localização" type="tel" minlength="11" />
                                </div>
                                <div className="custom-file">
                                    <input type="file" className="custom-file-input" id="customFile" />
                                    <label className="custom-file-label" for="customFile">Escolher imagem</label>
                                </div>
